...
<body class="premium standard u-fix-fancybox-iframe">
    <form>
        ...
        <asp:DataList ID="Dtl_Artist" runat="server" CssClass="wrapper mod-standard mod-gray"
            GridLines="None" RepeatColumns="1" RepeatDirection="Vertical" RepeatLayout="Flow" DataKeyField="artistID">
            <ItemTemplate>
                    ...
                    <main class="discovery--section">
                        ...
                        <section class="standard--holder">
                            <div class="discovery--section--header">
                                <h2>Top Songs</h2>
                                <a class="discovery--section--header--view-all" href="#">View All
                                </a>
                            </div>
                            <!-- /.discovery-select -->


                            <asp:DataList ID="Dtl_Songs" runat="server" Width="100%"
                                ShowHeader="false" GridLines="None" RepeatDirection="Vertical"
                                CssClass="song-list mod-new mod-menu" DataKeyField="songID">
                                <ItemStyle CssClass="song-list--item media-player--row" />
                                <ItemTemplate>
                                    <div class="song-list--item--player-img media-player">
                                        <img class="song-list--item--player-img--img"
                                            srcset="<%#Eval("albumUrl") %> 2x"
                                            src="<%#Eval("albumUrl") %>" alt="Way Maker" />
                                    </div>
                        ...
                        <div class="discovery--space-saver">
                            <section class="standard--holder">
                                ...
                                <div class="discovery--grid-holder">
                                        ...
                                        <asp:DataList ID="Dtl_Albums" runat="server" Width="100%"
                                RepeatColumns="6"
                                CssClass="ly-grid ly-grid-cranberries" DataKeyField="albumID">
                                            <ItemStyle CssClass="media-item" />
                                <ItemTemplate>
                                    <div style="padding: 2px 10px; margin-right: auto; margin-left: auto;">
                                            <a class="media-item--img--link" href="#" tabindex="0">
                                                <img class="media-item--img" alt="<%#Eval("title") %>" width="324" height="324"
                                                    src="<%#Eval("imageURL") %>" srcset="<%#Eval("imageURL") %>, <%#Eval("imageURL") %> 2x">
                                                <span class="image-tag"><%#Eval("title") %></span>
                                            </a>
                                            <a class="media-item--title" href="#" tabindex="0"><%#Eval("title") %></a>
                                            <a class="media-item--subtitle" href="#" tabindex="0"><%#Eval("artistName") %> <%#Eval("year") %></a>
                                        </div>
                                    </ItemTemplate>
                                            </asp:DataList>
                                    <!-- /.grid -->
